#!/usr/bin/perl
#
# Used to generate the input file  seqsource-baryon.ini.xml
#
...
print <<EOF;
    ...
    <elem>
      ...
      <NamedObject>
        ...
        <operator_coeff_files>
          <elem>
            <coeff_file>./Single_Site</coeff_file>
            <id>Single_Site</id>
          </elem>
          <elem>
            <coeff_file>./Singly_Displaced</coeff_file>
            <id>Singly_Displaced</id>
          </elem>
        </operator_coeff_files>
        <Quarks>
          <elem>
