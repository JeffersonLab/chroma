/*
 *  $Id: hypsmear3d.cc,v 1.4 2005-02-28 03:34:46 edwards Exp $
 *
...
void read(XMLReader& xml, const string& path, Param_t& param)
{
  ...
  case 3:
    ...
    {
      QDP_error_exit( "hypsmear3d.cc: invalid number of hyp smearing iterations, link_smear_num = %d", param.link_smear_num );
    }
    break;
...
int main(int argc, char *argv[])
{
  ...
  MesPlq(xml_out, "HYP_observables", u);
  xml_out.flush();
