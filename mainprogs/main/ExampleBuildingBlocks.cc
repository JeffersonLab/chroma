...
// history:
//
// There were at least four versions of "MIT" code.  Andrew Pochinsky had a c version.
// Dmitri Dolgov had a c++ version.  Dru B. Renner had c and c++ versions.  All were
// independent and checked against one another.  Of course, all were developed under 
// the guidance of John W. Negele.
//
// authors:
//
