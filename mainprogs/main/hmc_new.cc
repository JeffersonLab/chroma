...
{ 
  ...
  void doHMC(multi1d<LatticeColorMatrix>& u,
	     AbsHMCTrjNew<multi1d<LatticeColorMatrix>,
...
Chroma::initialize(&argc, &argv);
  ...
  NewExactHamParams ham_params(H_MC_xml, "/Hamiltonian");
    
  Handle< NewAbsHamiltonian< multi1d<LatticeColorMatrix>,     
    multi1d<LatticeColorMatrix> > > H_MC(new NewExactHam(ham_params));
  ...
  Handle< AbsMDIntegratorNew< multi1d<LatticeColorMatrix>,
    multi1d<LatticeColorMatrix> > > Integrator(new LCMToplevelIntegrator(int_par));


  LatColMatHMCTrjNew theHMCTrj( H_MC, Integrator );
