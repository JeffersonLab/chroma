...
int main(int argc, char **argv)
{
  ...
  // Naive Dslash
  QDPIO::cout << "Consturcting Naive 5D Dslash, N5=" << N5 << std::endl;
  ...
  for(isign = 1; isign >= -1; isign -= 2) {
	...
	for(iter=1; ; iter <<= 1)
	{
	  QDPIO::cout << "Applying naive D5 " << iter << " times" << std::endl;
      ...
      QDPIO::cout << "Applying naive D5 for timings" << std::endl;
  ...
  //! Naive loop
  QDPIO::cout << "Constructing (possibly optimized) WilsonDslash to do std::vector operation with a loop" << std::endl;
  ...
  for(isign = 1; isign >= -1; isign -= 2) {
	...
	for(iter=1; ; iter <<= 1)
	{
	  QDPIO::cout << "Applying D_opt_loop " << iter << " times" << std::endl;
      ...
      QDPIO::cout << "Applying D_opt_loop for timings" << std::endl;
  ...
  //! Create a linear operator
  QDPIO::cout << "Constructing (possibly optimized) WilsonDslashArray N5="<< N5 << std::endl;
  ...
  for(isign = 1; isign >= -1; isign -= 2) {
	...
	for(iter=1; ; iter <<= 1)
	{
	  QDPIO::cout << "Applying D5_opt " << iter << " times" << std::endl;
      ...
      QDPIO::cout << "Applying D5_opt for timings" << std::endl;
