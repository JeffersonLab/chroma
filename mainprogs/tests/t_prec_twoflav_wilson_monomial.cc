...
int main(int argc, char *argv[]) 
{
  ...
  Handle<ExactEvenOddPrecWilsonTypeFermMonomial<multi1d<LatticeColorMatrix>,
                                                multi1d<LatticeColorMatrix>, 
                                                LatticeFermion> > S_w(

     TheExactEvenOddPrecWilsonTypeFermMonomialFactory::Instance().createObject(
                                              monomial_name, 
					      fbc, 
					      param_in, 
