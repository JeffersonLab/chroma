...
#ifndef __eoprec_exp_clov_logdet_even_even_monomial_h__
#define __eoprec_exp_clov_logdet_even_even_monomial_h__
...
namespace Chroma 
{
  ...
  //! A Monomial For Just the EvenEven part of EvenOddExpClovPrecLogDetWilsonTypeFermActs
  /*! @ingroup monomial
   *
   * Monomial is expected to be the same for these fermacts
   */
  template<typename P, typename Q, typename Phi>
  class EvenOddExpClovPrecLogDetEvenEvenMonomial : public ExactMonomial<P,Q>    
  {
  public: 
    virtual ~EvenOddExpClovPrecLogDetEvenEvenMonomial() {}
	...
	push(xml_out, "EvenOddExpClovPrecLogDetEvenEvenMonomial");
  ...
  /*! @ingroup monomial */
  namespace EvenOddExpClovPrecLogDetEvenEvenMonomial4DEnv 
  {
    bool registerAll();
  }
  ...
  // Parameter structure
  /*! @ingroup monomial */
  struct EvenOddExpClovPrecLogDetEvenEvenMonomialParams 
  {
    // Base Constructor
