// $Id: prec_constdet_two_flavor_polyprec_monomial_w.cc,v 2.2 2006-02-10 02:45:55 edwards Exp $
/*! @file
...
{ 
  ...
  namespace EvenOddPrecConstDetTwoFlavorPolyPrecWilsonTypeFermMonomialEnv 
  {
    ...
    //! Identifier
    const std::string name = "TWO_FLAVOR_POLYPREC_FERM_MONOMIAL";
    ...
    const TwoFlavorWilsonTypeFermMonomialParams& param_) 
  {
	...
	QDP_abort(1);
      ...
      QDPIO::cout << EvenOddPrecConstDetTwoFlavorPolyPrecWilsonTypeFermMonomialEnv::name << ": construct " << fermact_string << endl;
