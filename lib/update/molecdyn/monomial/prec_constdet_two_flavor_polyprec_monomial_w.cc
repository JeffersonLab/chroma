// $Id: prec_constdet_two_flavor_polyprec_monomial_w.cc,v 2.1 2006-02-09 22:26:41 edwards Exp $
/*! @file
...
{ 
    ...
    const TwoFlavorWilsonTypeFermMonomialParams& param_) 
  {
	...
	QDP_abort(1);
      ...
      QDPIO::cout << "EvanOddPrecTwoFlavorPolyPrecWilsonTypeFermMonomial: construct " << fermact_string << endl;
      ...
      if( downcast == 0x0 ) {
	QDPIO::cerr << "Unable to downcast FermAct to EvenOddPrecWilsonTypeFermAct in EvenOddPrecConstDetTwoFlavorPolyPrecWilsonTypeFermMonomial()" << endl;
	QDP_abort(1);
      }
