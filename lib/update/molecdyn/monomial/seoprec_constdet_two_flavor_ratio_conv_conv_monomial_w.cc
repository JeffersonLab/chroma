...
{ 
  ...
  namespace SymEvenOddPrecConstDetTwoFlavorRatioConvConvWilsonTypeFermMonomialEnv
  {
    namespace
    {
      ...
      {
	return new SymEvenOddPrecConstDetTwoFlavorRatioConvConvWilsonTypeFermMonomial(
    ...
    const std::string name("TWO_FLAVOR_SEOPREC_CONSTDET_RATIO_CONV_CONV_FERM_MONOMIAL");
  ...
  // Constructor
  SymEvenOddPrecConstDetTwoFlavorRatioConvConvWilsonTypeFermMonomial::SymEvenOddPrecConstDetTwoFlavorRatioConvConvWilsonTypeFermMonomial(
    const TwoFlavorRatioConvConvWilsonTypeFermMonomialParams& param) 
  {
	...
	TheWilsonTypeFermActFactory::Instance().createObject(param.numer.fermact.id, 
      ...
      SymEvenOddPrecWilsonTypeFermAct<T,P,Q>* downcast=dynamic_cast<SymEvenOddPrecWilsonTypeFermAct<T,P,Q>*>(tmp_act);
