...
{ 
  ...
  namespace SymEvenOddPrecConstDetTwoFlavorWilsonTypeFermMonomialEnv
  {
    namespace
    {
      ...
      {
	return new SymEvenOddPrecConstDetTwoFlavorWilsonTypeFermMonomial(
    ...
    const std::string name("TWO_FLAVOR_SEOPREC_CONSTDET_FERM_MONOMIAL");
  ...
  // Constructor
  SymEvenOddPrecConstDetTwoFlavorWilsonTypeFermMonomial::SymEvenOddPrecConstDetTwoFlavorWilsonTypeFermMonomial(
    const TwoFlavorWilsonTypeFermMonomialParams& param) 
  {
    ...
    QDPIO::cout << "SymEvenOddPrecConstDetTwoFlavorWilsonTypeFermMonomial: construct " << param.fermact.id << std::endl;
    ...
    SymEvenOddPrecWilsonTypeFermAct<T,P,Q>* downcast =
      dynamic_cast<SymEvenOddPrecWilsonTypeFermAct<T,P,Q>*>(tmp_act);

    // Check success of the downcast 
    if( downcast == 0x0 ) {
      QDPIO::cerr << "Unable to downcast FermAct to SymEvenOddPrecWilsonTypeFermAct in SymEvenOddPrecConstDetTwoFlavorWilsonTypeFermMonomial()" << std::endl;
      QDP_abort(1);
    }
