// $Id: eoprec_constdet_two_flavor_ratio_conv_conv_monomial5d_w.cc,v 3.1 2008-05-23 21:31:33 edwards Exp $
/*! @file
...
{ 
  ...
  // Constructor
  EvenOddPrecConstDetTwoFlavorRatioConvConvWilsonTypeFermMonomial5D::EvenOddPrecConstDetTwoFlavorRatioConvConvWilsonTypeFermMonomial5D(
