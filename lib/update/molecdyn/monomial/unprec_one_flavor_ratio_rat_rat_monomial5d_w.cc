// $Id: unprec_one_flavor_ratio_rat_rat_monomial5d_w.cc,v 3.1 2008-05-23 21:31:35 edwards Exp $
/*! @file
 * @brief One-flavor collection of unpreconditioned 5D ferm monomials
 */

#include "update/molecdyn/monomial/unprec_one_flavor_ratio_rat_rat_monomial5d_w.h"
...
{ 
  ...
  namespace UnprecOneFlavorWilsonTypeFermRatioRatRatMonomial5DEnv 
  {
    namespace
    {
      //! Callback
      ...
      {
	return new UnprecOneFlavorWilsonTypeFermRatioRatRatMonomial5D(
  ...
  // Constructor
  UnprecOneFlavorWilsonTypeFermRatioRatRatMonomial5D::UnprecOneFlavorWilsonTypeFermRatioRatRatMonomial5D(
