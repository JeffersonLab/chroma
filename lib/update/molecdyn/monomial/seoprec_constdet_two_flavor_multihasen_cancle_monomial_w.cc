		...
		namespace
		{
			...
			Monomial<multi1d<LatticeColorMatrix>,
				multi1d<LatticeColorMatrix> >* createMonomial(XMLReader& xml, const std::string& path)
				{
					...
					//using FA = SymEvenOddPrecWilsonTypeFermAct<T,P,Q>;
					//using LO = SymEvenOddPrecLogDetLinearOperator<T,P,Q>;
					//typedef SymEvenOddPrecWilsonTypeFermAct FA;
					//typedef SymEvenOddPrecLogDetLinearOperator LO;
