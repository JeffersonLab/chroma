...
#include "update/molecdyn/monomial/eoprec_constdet_one_flavor_ratio_rat_rat_monomial_w.h"
...
{ 
  ...
  namespace EvenOddPrecConstDetOneFlavorWilsonTypeFermRatioRatRatMonomialEnv 
  {
    namespace
    {
      //! Callback
      ...
      {
	return new EvenOddPrecConstDetOneFlavorWilsonTypeFermRatioRatRatMonomial(
  ...
  } //end namespace EvenOddPrec OneFlavorWilsonFermRatioRatRatMonomialEnv



  // Constructor
  EvenOddPrecConstDetOneFlavorWilsonTypeFermRatioRatRatMonomial::EvenOddPrecConstDetOneFlavorWilsonTypeFermRatioRatRatMonomial(
    const OneFlavorWilsonTypeFermRatioRatRatMonomialParams& param) 
  {
	...
	TheWilsonTypeFermActFactory::Instance().createObject(param.numer.fermact.id, 
      ...
      if( downcast == 0x0 ) 
      {
	QDPIO::cerr << __func__ << ": unable to downcast FermAct to EvenOddPrecWilsonTypeFermAct" << endl;
	QDP_abort(1);
      }
