// $Id: eoprec_constdet_two_flavor_hasenbusch_monomial_w.cc,v 3.1 2006-10-19 16:01:34 edwards Exp $
/*! @file
...
{ 
    ...
    const TwoFlavorHasenbuschWilsonTypeFermMonomialParams& param) 
  {
...

    {
      ...
      QDPIO::cout << "EvanOddPrecTwoFlavorHasenbuschWilsonTypeFermMonomial: construct " 
    ...
    {
      std::istringstream is(param.fermact_prec.xml);
      XMLReader fermact_reader(is);
      QDPIO::cout << "EvenOddPrecTwoFlavorHasenbuschWilsonTypeFermMonomial: construct " 
		  << param.fermact_prec.id << endl;
      
      WilsonTypeFermAct<T,P,Q>* tmp_act = 
	TheWilsonTypeFermActFactory::Instance().createObject(param.fermact_prec.id, fermact_reader, param.fermact_prec.path);
