...
#include "update/molecdyn/integrator/lcm_sts_test_min_norm2_recursive.h"
...
{ 
  ...
  namespace LatColMatSTSTestMinNorm2RecursiveIntegratorEnv 
  {
	...
	LatColMatSTSTestMinNorm2RecursiveIntegratorParams p(xml, path);
    
	return new LatColMatSTSTestMinNorm2RecursiveIntegrator(p);
      }
    ...
    const std::string name = "LCM_STS_TEST_MIN_NORM_2";
  ...
  LatColMatSTSTestMinNorm2RecursiveIntegratorParams::LatColMatSTSTestMinNorm2RecursiveIntegratorParams(XMLReader& xml_in, const std::string& path) 
  {
	...
	QDPIO::cout << subintegrator_xml << endl;
      ...
      QDPIO::cout << "Error reading XML in LatColMatSTSTestMinNorm2RecursiveIntegratorParams " << e << endl;
      QDP_abort(1);
    }
  }
  ...
  void read(XMLReader& xml, 
    ...
    LatColMatSTSTestMinNorm2RecursiveIntegratorParams tmp(xml, path);
    p = tmp;
  }
  ...
  void LatColMatSTSTestMinNorm2RecursiveIntegrator::operator()( 
