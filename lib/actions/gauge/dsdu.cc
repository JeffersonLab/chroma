/* + */
/* $Id: dsdu.cc,v 1.1 2004-02-23 03:06:08 edwards Exp $ ($Date: 2004-02-23 03:06:08 $) */

/* DSDU -- computes the derivative of the Wilson (and Symanzik improved) */
