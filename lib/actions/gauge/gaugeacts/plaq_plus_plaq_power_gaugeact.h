// -*- C++ -*-
/*! \file
 *  \brief Plaquette plus plaquette to a power gauge action
 */
...
namespace Chroma
{
  ...
  { 
    ...
    struct Params 
    {
      ...
      Real  gamma;  // Coupling for plaquette raised to q
      int   q;      // Power
    };
  

    //! PlaqPlusPlaqPoweruette gauge action
    /*! \ingroup gaugeacts
     *
     * The standard PlaqPlusPlaqPoweruette gauge action
     */
