...
namespace Chroma
{
  ...
  LinOpSysSolverQUDAMULTIGRIDExpClover::qudaInvert(const ExpCloverTermT<T, U>& clover,
...
//Check to compare with Chroma exp-clover op
	...
	void LinOpSysSolverQUDAMULTIGRIDExpClover::qudaInvertMultiSrc( const ExpCloverTermT<T, U>& invclov,
