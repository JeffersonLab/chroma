...
#ifndef LIB_ACTIONS_FERM_INVERT_MG_PROTO_SYSSOLVER_LINOP_ALI_MG_PROTO_QPHIX_EO_H_
#define LIB_ACTIONS_FERM_INVERT_MG_PROTO_SYSSOLVER_LINOP_ALI_MG_PROTO_QPHIX_EO_H_
...
//! Registration and other yuckies
  ...
  public:
	  ...
	  LinOpSysSolverMGProtoQPhiXALI(Handle< LinearOperator<T> > A_,
			  Handle< FermState<T,Q,Q> > state_,
			  const MGProtoALIPrecParams& invParam_);

	  ~LinOpSysSolverMGProtoQPhiXALI();
...
#endif /* LIB_ACTIONS_FERM_INVERT_MG_PROTO_SYSSOLVER_LINOP_ALI_MG_PROTO_H_ */
