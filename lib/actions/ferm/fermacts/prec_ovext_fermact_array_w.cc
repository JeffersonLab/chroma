...
namespace Chroma
{
  ...
  namespace EvenOddPrecOvExtFermActArrayEnv
  {
    ...
    {
      return new EvenOddPrecOvExtFermActArray(WilsonTypeFermBCArrayEnv::reader(xml_in, path), 
  ...
  EvenOddPrecOvExtFermActArray::qprop(Handle<const ConnectState> state,
				 const InvertParam_t& invParam) const
  {
    ...
    Handle< LinearOperator<LatticeFermion> > D_w(new UnprecWilsonLinOp(u, -param.OverMass));
