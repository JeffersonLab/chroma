// -*- C++ -*-
// $Id: prec_dwf_fermact_base_w.h,v 1.1 2003-11-23 05:52:20 edwards Exp $
/*! \file
...
public:
  ...
  virtual const EvenOddPrecLinearOperator<LatticeDWFermion>* linOpPV(const multi1d<LatticeColorMatrix>& u) const = 0;
