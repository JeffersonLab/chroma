// -*- C++ -*-
// $Id: unprec_dwf_fermact_base_w.h,v 1.4 2003-12-02 15:45:04 edwards Exp $
/*! \file
...
public:
  ...
  virtual const LinearOperator<LatticeDWFermion>* linOpPV(const ConnectState& state) const = 0;
