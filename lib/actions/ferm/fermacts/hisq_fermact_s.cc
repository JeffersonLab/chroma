...
{ 
  ...
  //! Return a linear operator solver for this action to solve M*psi=chi
   ...
   LinOpMRHSSystemSolver<HisqFermAct::T>*
   HisqFermAct::invLinOpMRHS(Handle< FermState<T,P,Q> > state,
   ...
   /*! Default implementation */
   MdagMMRHSSystemSolver<HisqFermAct::T>*
   HisqFermAct::invMdagMMRHS(Handle< FermState<T,P,Q> > state,
 		  const GroupXML_t& invParam) const
   {
 	  QDPIO::cout << "invLinOpMRHS is not implemented" << std::endl;
 	  QDP_abort(1);
