// -*- C++ -*-
// $Id: unprec_ppdwf4d_linop_w.h,v 1.1 2004-12-10 02:54:24 edwards Exp $
/*! \file
...
namespace Chroma
{
  ...
  public:
    ...
    UnprecPPDWF4DLinOp(const EvenOddPrecLinearOperator< multi1d<T> >* D_, 
		       const EvenOddPrecLinearOperator< multi1d<T> >* PV_,
		       const InvertParam_t& invParam_) : 
      D(D_), PV(PV_), invParam(invParam_) {}

    //! Copy pointer (one more owner)
    UnprecPPDWF4DLinOp(Handle<const EvenOddPrecLinearOperator< multi1d<T> > > D_, 
		       Handle<const EvenOddPrecLinearOperator< multi1d<T> > > PV_,
  ...
  private:
    ...
    const Handle< const EvenOddPrecLinearOperator< multi1d<T> > > PV;
    const InvertParam_t& invParam;
  };
