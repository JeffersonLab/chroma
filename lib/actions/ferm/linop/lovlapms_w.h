...
{ 
  ...
  class lovlapms : public UnprecLinearOperator< LatticeFermion, multi1d<LatticeColorMatrix> >
  {
  public:
    //! Creation routine
    /*!
     ...
     */
    lovlapms(const UnprecWilsonTypeFermAct< LatticeFermion, multi1d<LatticeColorMatrix> >& S_aux,
