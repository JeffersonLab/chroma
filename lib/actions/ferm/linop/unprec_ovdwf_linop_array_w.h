// -*- C++ -*-
// $Id: unprec_ovdwf_linop_array_w.h,v 1.12 2005-05-28 22:37:42 edwards Exp $
/*! \file
...
namespace Chroma
{
   ...
   */
  class UnprecOvDWLinOpArray : public UnprecDWLikeLinOpBaseArray< LatticeFermion, multi1d<LatticeColorMatrix> >
  {
  public:
    //! Partial constructor
