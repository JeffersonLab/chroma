// -*- C++ -*-
// $Id: zolotarev5d_linop_array_w.h,v 1.1 2004-01-13 10:00:57 bjoo Exp $
/*! \file
 *  \brief Unpreconditioned extended-Overlap (5D) (Naryanan&Neuberger) linear operator
 */

#ifndef __zolotarev5d_linop_array_w_h__
#define __zolotarev5d_linop_array_w_h__
...
class Zolotarev5DLinOpArray : public LinearOperator< multi1d<LatticeFermion> >
{
public:

  //! Full constructor
  Zolotarev5DLinOpArray(const UnprecWilsonTypeFermAct<LatticeFermion>& S_aux,
