// -*- C++ -*-
// $Id: prec_dwf_linop_base_array_w.h,v 1.4 2004-12-12 21:22:16 edwards Exp $
/*! \file
...
namespace Chroma
{
   ...
   */
  template<typename T>
  class EvenOddPrecDWLinOpBaseArray : public EvenOddPrecLinearOperator< multi1d<T>, multi1d<LatticeColorMatrix> >
  {
  public:
