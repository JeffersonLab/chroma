// -*- C++ -*-
// $Id: lovddag_double_pass_w.h,v 1.2 2004-05-14 15:08:42 bjoo Exp $
/*! \file
...
class lovddag_double_pass : public ApproxLinearOperator<LatticeFermion>
{
public:
  //! Creation routine
  /*!
   ...
   */
  lovddag_double_pass(const UnprecWilsonTypeFermAct<LatticeFermion>& S_aux,
