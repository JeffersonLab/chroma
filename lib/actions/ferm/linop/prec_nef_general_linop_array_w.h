// -*- C++ -*-
// $Id: prec_nef_general_linop_array_w.h,v 1.3 2004-12-12 21:22:16 edwards Exp $
/*! \file
...
namespace Chroma
{
   ...
   */
  class EvenOddPrecGenNEFDWLinOpArray : public EvenOddPrecDWLinOpBaseArray<LatticeFermion>
  {
  public:
    //! Partial constructor
