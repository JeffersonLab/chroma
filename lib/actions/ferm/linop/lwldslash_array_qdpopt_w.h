// -*- C++ -*-
// $Id: lwldslash_array_qdpopt_w.h,v 3.2 2008-01-21 20:18:50 edwards Exp $
/*! \file
 *  \brief Wilson Dslash linear operator over arrays
 */

#ifndef __lwldslash_array_opt_h__
#define __lwldslash_array_opt_h__
...
{ 
  ...
  class QDPWilsonDslashArrayOpt : public WilsonDslashBaseArray
  {
  public:
    ...
    //! Full constructor
    QDPWilsonDslashArrayOpt(Handle< FermState<T,P,Q> > state,
			 int N5_)
      {create(state,N5_);}
