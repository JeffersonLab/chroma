// $Id: unprec_ppdwf4d_linop_w.cc,v 2.0 2005-09-25 21:04:30 edwards Exp $
/*! \file
...
namespace Chroma
{
  ...
  template<>
  void 
  UnprecPPDWF4DLinOp< LatticeFermion, multi1d<LatticeColorMatrix> >::operator()(LatticeFermion& chi, 
