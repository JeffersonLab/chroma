// $Id: dwf_quarkprop4_w.cc,v 1.13 2004-02-05 21:15:05 kostas Exp $
			     ...
			     const Real& m_q)
{
  ...
  QDPIO::cout<<"check_dwf_ward_identity: Ward Identity violation per timeslice: "<<endl;
  for(int t(0);t<corr.size(); t++){
    QDPIO::cout<<"        "<<t<<"                "<< corr[t]<<endl ;
  }
