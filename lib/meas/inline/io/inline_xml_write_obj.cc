// $Id: inline_xml_write_obj.cc,v 2.1 2006-03-14 04:55:30 edwards Exp $
/*! \file
...
{ 
  ...
  { 
    ...
    bool registerAll() 
    {
      ...
      // Datatype writer
      success &= XMLWriteObjCallMapEnv::registered;
  ...
  void 
  InlineXMLWriteNamedObj::operator()(const multi1d<LatticeColorMatrix>& u,
