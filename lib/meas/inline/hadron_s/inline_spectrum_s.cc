// $Id: inline_spectrum_s.cc,v 1.1 2005-08-23 17:29:55 mcneile Exp $
/*! \file
...
{ 
  ...
  //! Propagator input
  void read(XMLReader& xml, const string& path, InlineSpectrumParams_s::Prop_t& input)
  {
  ...
  //! Propagator output
  void write(XMLWriter& xml, const string& path, const InlineSpectrumParams_s::Prop_t& input)
  {
    push(xml, path);
