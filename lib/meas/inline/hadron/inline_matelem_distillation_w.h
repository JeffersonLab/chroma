...
#ifndef __inline_matelem_distillation_w_h__
#define __inline_matelem_distillation_w_h__
...
{ 
  ...
  namespace InlineMatElemDistillationEnv 
  {
	...
	struct Contract_t
	{
	  ...
	  int           lt_orig;        /*!< Number of color vectors to use */
	  int           t_offset;       /*!< Number of color vectors to use */
	...
	std::string                 prop_file;       /*!< File name for propagator matrix elements */
	std::string                 peram_file;      /*!< File name for propagator matrix elements */
      };
