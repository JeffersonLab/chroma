// -*- C++ -*-
// $Id: inline_block_genprop_matelem_w.h,v 1.1 2009-02-23 19:44:30 edwards Exp $
/*! \file
...
#ifndef __inline_block_genprop_matelem_h__
#define __inline_block_genprop_matelem_h__
...
{ 
  ...
  namespace InlineBlockGenPropMatElemEnv 
  {
	...
	bool                    avg_equiv_mom;          /*!< Average over rotations of momenta at fixed mom^2 */
