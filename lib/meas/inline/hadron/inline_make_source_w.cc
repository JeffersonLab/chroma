// $Id: inline_make_source_w.cc,v 3.0 2006-04-03 04:59:02 edwards Exp $
/*! \file
...
{ 
			 ...
			 XMLWriter& xml_out) 
  {
	...
	sourceConstruction(ThePropSourceConstructionFactory::Instance().createObject(params.param.source_type,
										     sourcetop,
										     source_path));
