// $Id: hadron_seqsource.cc,v 3.6 2006-11-27 04:33:35 edwards Exp $
/*! \file
...
namespace Chroma 
{
  ...
  namespace
  {
    ...
    /*! @ingroup hadron */
    LatticeComplex hadSeqSourcePhase(const multi1d<int>& t_srce, 
  ...
  {
    return hadSeqSourcePhase(getTSrce(), getSinkMom(), getDecayDir());
  }
