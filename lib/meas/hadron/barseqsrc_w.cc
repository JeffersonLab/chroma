// $Id: barseqsrc_w.cc,v 1.1 2003-12-17 03:56:46 edwards Exp $
/*! \file
		  ...
		  int j_decay, int seq_src)
{
  ...
  /*  g_tmp1  = Gamma(5) * ( 1 + g_4 ) = g_3 g_1 ( 1 + g_4 ) 
      = C gamma_5 ( 1 + g_4 ) */

  g_tmp1 = Gamma(5) * Cg5NR;
  ftmp = 0.5;
  
  /* C g_5 NR = (1/2)* dummy = (1/2)*C gamma_5 * ( 1 + g_5 ) */ 
  Cg5NR = g_tmp1 * ftmp;
  ...
  case 0:
    ...
    ftmp = 0.5;
    {
      ...
      q2_tmp = quark_propagator_1;
      q2_tmp += quark_propagator_1 * Gamma(8);
      src_prop_tmp -= quarkContract13(q1_tmp, q2_tmp);

      src_prop_tmp -= quarkContract12(q2_tmp, q1_tmp);

      src_prop_tmp = src_prop_tmp * ftmp;
    }
  ...
  case 3:
    ...
    i_fac = -(i_fac * ftmp);
    {
      /* C gamma_5 = Gamma(5) = - (C gamma_5)^T */
      q2_tmp = quark_propagator_1 * Gamma(5);
      q1_tmp = Gamma(3) * q2_tmp;
      q1_tmp += Gamma(11) * q2_tmp;
      q2_tmp = Gamma(5) * quark_propagator_1;
      src_prop_tmp = -quarkContract14(q1_tmp, q2_tmp);
  ...
  case 4:
    ...
    ftmp = 2;
    {
      ...
      di_quark = quarkContract24(q1_tmp, q2_tmp);
      src_prop_tmp = di_quark;
      src_prop_tmp += Gamma(8) * di_quark;
      ...
      q2_tmp = q1_tmp * Cgm;
      q1_tmp = quark_propagator_2;
      q1_tmp += Gamma(8) * quark_propagator_2;
      src_prop_tmp += quarkContract12(q1_tmp, q2_tmp);

      src_prop_tmp += quarkContract24(q1_tmp, q2_tmp);
  ...
  case 21:
    ...
    ftmp = 0.5; 
    FILL(i_fac, I);
    i_fac = -i_fac;	// i_fac now contains -i

    {
      ...
      q1_tmp = Gamma(3) * di_quark;
      q1_tmp += Gamma(11) * di_quark;
      /*
       *  Now multiply by -i
       */

      src_prop_tmp = q1_tmp * i_fac;
      ...
      di_quark = Gamma(3) * q1_tmp;
      di_quark += Gamma(11) * q1_tmp;
      q1_tmp = di_quark * i_fac; /*  Multiply by -i */
      ...
      di_quark = quark_propagator_1 * Gamma(3);
      di_quark += quark_propagator_1 * Gamma(11);
      q2_tmp = di_quark * i_fac;	/* Muliply by -i */
  ...
  case 22:
...

    {
      ...
      di_quark = Gamma(3) * q2_tmp;
      di_quark += Gamma(11) * q2_tmp;
      q1_tmp = di_quark * i_fac;
