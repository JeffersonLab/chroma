// $Id: barhqlq_w.cc,v 1.7 2005-09-21 05:13:21 edwards Exp $
/*! \file
	     ...
	     multi3d<DComplex>& barprop)
{
  ...
  for(int baryons = 0; baryons < num_baryons; ++baryons)
  {
    ...
    case 0:
      ...
      b_prop = trace(S_proj * traceColor(quark_propagator_2 * traceSpin(di_quark)))
	     + trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      break;
    ...
    case 1:
      ...
      di_quark = quarkContract13(quark_propagator_2 * Gamma(5),
				 Gamma(5) * quark_propagator_1);
      b_prop += trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      break;
    ...
    case 2:
      ...
      // S_proj = T = (1 + \Sigma_3)*(1 + gamma_4) / 2 
      //            = (1 + Gamma(8) - i G(3) - i G(11)) / 2
      di_quark = quarkContract13(quark_propagator_1 * Cgm, 
				 Cgm * quark_propagator_2);
      b_prop = trace(S_proj * traceColor(quark_propagator_2 * traceSpin(di_quark)))
	     + trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      
      di_quark = quarkContract13(quark_propagator_2 * Cgm, 
				 Cgm * quark_propagator_1);
      b_prop += trace(S_proj * traceColor(quark_propagator_2 * di_quark));
    ...
    case 3:
      ...
      // S_proj = T = (1 + \Sigma_3)*(1 + gamma_4) / 2 
      //            = (1 + Gamma(8) - i G(3) - i G(11)) / 2
      di_quark = quarkContract13(quark_propagator_1 * Gamma(13),
				 Gamma(13) * quark_propagator_2);
      b_prop = trace(S_proj * traceColor(quark_propagator_2 * traceSpin(di_quark)))
	     + trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      break;
    ...
    case 4:
      ...
      // WARNING: I'm not convinced the original SZIN version (or this version) is correct!
      di_quark = quarkContract13(quark_propagator_2 * Gamma(13),
				 Gamma(13) * quark_propagator_2);
      b_prop  = trace(S_proj * traceColor(quark_propagator_1 * traceSpin(di_quark)))
	      + trace(S_proj * traceColor(quark_propagator_1 * di_quark));

      di_quark = quarkContract13(quark_propagator_2 * Gamma(13),
				 Gamma(13) * quark_propagator_1);
      b_prop += trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      break;
    ...
    case 5:
      ...
      // S_proj = T = (1 + \Sigma_3)*(1 + gamma_4) / 2 
      //            = (1 + Gamma(8) - i G(3) - i G(11)) / 2
      di_quark = quarkContract13(quark_propagator_1 * Cg4m, 
				 Cg4m * quark_propagator_2);
      b_prop = trace(S_proj * traceColor(quark_propagator_2 * traceSpin(di_quark)))
	     + trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      
      di_quark = quarkContract13(quark_propagator_2 * Cg4m, 
				 Cg4m * quark_propagator_1);
      b_prop += trace(S_proj * traceColor(quark_propagator_2 * di_quark));
    ...
    case 6:
      ...
      // S_proj = T = (1 + \Sigma_3)*(1 + gamma_4) / 2 
      //            = (1 + Gamma(8) - i G(3) - i G(11)) / 2
      di_quark = quarkContract13(quark_propagator_1 * Cg5NR,
    ...
    case 7:
      ...
      // WARNING: I'm not convinced the original SZIN version (or this version) is correct!
      di_quark = quarkContract13(quark_propagator_2 * Cg5NR,
				 Cg5NR * quark_propagator_2);
      b_prop  = trace(S_proj * traceColor(quark_propagator_1 * traceSpin(di_quark)))
	      + trace(S_proj * traceColor(quark_propagator_1 * di_quark));

      di_quark = quarkContract13(quark_propagator_2 * Cg5NR,
				 Cg5NR * quark_propagator_1);
      b_prop += trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      break;
    ...
    case 8:
      ...
      // S_proj = T = (1 + \Sigma_3)*(1 + gamma_4) / 2 
      //            = (1 + Gamma(8) - i G(3) - i G(11)) / 2
      di_quark = quarkContract13(quark_propagator_1 * CgmNR, 
				 CgmNR * quark_propagator_2);
      b_prop = trace(S_proj * traceColor(quark_propagator_2 * traceSpin(di_quark)))
	     + trace(S_proj * traceColor(quark_propagator_2 * di_quark));
      
      di_quark = quarkContract13(quark_propagator_2 * CgmNR, 
				 CgmNR * quark_propagator_1);
      b_prop += trace(S_proj * traceColor(quark_propagator_2 * di_quark));
