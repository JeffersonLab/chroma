// -*- C++ -*-
// $Id: group_baryon_operator_w.h,v 1.9 2006-10-13 15:16:24 juge Exp $
/*! \file
...
namespace Chroma
{
  ...
  namespace GroupBaryonOperatorEnv
  {
    ...
    class GroupBaryonQQQ : public BaryonOperator<LatticeFermion>
    {
      public:
        //! Full constructor
        GroupBaryonQQQ( const Params& p, const multi1d<LatticeColorMatrix>& u );
        ...
        multi1d<QuarkTerm_t> quark; /*!< Displacement and spin for each quark */
				...
				//
        // Example: orderings[ ord ].hlist( ii, jj, kk ).mom[ p ]
        //
        struct QQQOrdering_t
        {
          struct QQQHybridList_t
          {
            multi1d<DComplex> mom; /*!< momenta array */
          };
        ...
        int Nmomenta; // out of laziness to get this right from Env params ... do something about this
        ...
        multi1d<GroupBaryonOp*> baryon; // pointer to the BaryonOp array
				// ?
        void sum_sink( multi1d<multi1d<GroupBaryonOp> >& B, int Ndil1, int Ndil2, int Ndil3 );
...
/*
	...
	#
	#    (N+)         (I)   ijk       _(J)          _ijk     _ijk      _ijk         
	#   C        =   c     B      (t) c___  {     2 B  ___ + B  ___  + B  ___       
	#    IJ[012]      mnt   I<mnt>     mnt           J<mnt>   J<mtn>    J<nmt>      
	#                                               _ijk     _ijk      _ijk         
	#                                         - ( 2 B  ___ + B  ___  + B  ___  )    
	#                                                J<tnm>   J<tmn>    J<ntm>      
	#                                              														     
