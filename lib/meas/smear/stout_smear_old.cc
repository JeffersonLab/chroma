//  $Id: stout_smear_old.cc,v 3.1 2008-01-20 03:07:51 edwards Exp $
/*! \file
...
{ 
		       ...
		       multi1d<bool> smear_dirs)
  {
    ...
    // WARNING: this is not gauge-covariant. Only here for backwards compatibility.
    Real msmear_fact= sm_fact; 
