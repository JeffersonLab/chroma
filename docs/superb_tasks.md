...
## Contraction of correlation function graphs (generated by redstar)
    ...
    <InlineMeasurements>
      <elem>
        ...
        <Param>
          ...
          <Nt_forward>4</Nt_forward>
          <max_rhs>1</max_rhs>
          <max_moms_in_contraction_for_genprops>1</max_moms_in_contraction_for_genprops>
          <max_tslices_in_contraction_for_genprops>1</max_tslices_in_contraction_for_genprops>
          <ensemble>cl21</ensemble>
          <flavor_to_mass>
            <elem>
              <flavor>l</flavor>
              <mass>U-0.2390</mass>
          ...
          <baryons>
            <elem>baryons.sdb</elem>
          </baryons>
          <props>
            <elem>props.sdb</elem>
          </props>
          <genprops>
            <elem>genprops.sdb</elem>
          </genprops>
          <LinkSmearing>
            <LinkSmearingType>STOUT_SMEAR</LinkSmearingType>
            <link_smear_fact>0.1</link_smear_fact>
        ...
        <NamedObject>
          ...
          <corr_graph_file>graph.bin</corr_graph_file>
          <corr_file>corr.sdb</corr_file>
        </NamedObject>
      </elem>
    </InlineMeasurements>
    <nrow>2 2 2 4</nrow>
...
* `Param/max_rhs`: (optional, default is `1`) number of right-hand-sides to invert at once.
* `Param/max_moms_in_contraction_for_genprops`: (optional, default is `1`) maximum of number of momenta to contract at once when generating genprops.
* `Param/max_tslices_in_contraction_for_genprops`: (optional, default is `1`) maximum of time-slices to contract at once when generating genprops.
...
* `Param/genprops`: (optional, default empty) list of generatlized propagator database files.
* `Param/LinkSmearing`: smearing applied to the gauge links before doing the computation.
* `NamedObject/colorvec_files`: list of files with distillation basis.
* `NamedObject/corr_graph_file`: correlation function graph binary file generated by `redstar_corr_graph`.
* `NamedObject/corr_file`: output correlation function databse.

### Notes:

* The product of `Param/max_tslices_in_contraction_for_genprops` and `Param/max_moms_in_contraction_for_genprops` controls how much memory is used for contractions. Their tuning is more critical when using GPUs. The optimal value is usually the largest values of both parameters that the CPU or device can handle.
