...
_XI_0=2.464
_MASS=-0.373
_CFGLABEL=NF0/aniso/5p8_8_48_xi3p0_wl/
_GAUGEROOT=wqa_5p8_8_48_xi3p0.cfg
...
stagein()
{
 ...
 for machine in $machines ; do
    ...
    ${SCP} ${SERVER}:/raid3/baryons/simulation_input/First_Run/Nucleons/uud_props ${WORKDIR}
...
${SCP} ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/cfgs/${szingauge} .
...
${SCP} XMLDAT ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/xml/prop_src_xmldat.${prop_ctr}.cfg${cfg}
rm XMLDAT
...
${SCP} XMLDAT ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/xml/prop_xmldat.${prop_ctr}.cfg${cfg}
rm XMLDAT
...
${SCP} *PS*.cfg${cfg} ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/solver/.
...
${SCP} XMLDAT ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/xml/sink_xmldat.${prop_ctr}.cfg${cfg}
rm XMLDAT
...
${SCP} XMLDAT ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/xml/qqq_${_UD_PROP_ROOT}_${_S_PROP_ROOT}.${qqq_ctr}.cfg${cfg}
rm XMLDAT
...
${SCP} qqq_*.cfg${cfg} ${SERVER}:${_ARCHROOT}/${_CFGLABEL}/${_LSIZE}^3x${_TSIZE}/qqq/.

rm qqq_*.cfg${cfg}

ctr=`expr ${ctr} + 1 `
cfg=`expr ${cfg} + ${_CONFIG_SKIP} `
