...
#if 0
/* Global context */
EXTERN LatticeBoolean lattice_cb_context;
EXTERN LatticeBoolean lattice_even_context;
EXTERN LatticeBoolean lattice_odd_context;
#endif

/* Phases used by SETBC and FFTINIT */
EXTERN multi1d<LatticeComplex> *phases;
EXTERN multi1d<LatticeReal> *bc_phases;
EXTERN LatticeComplex *fft_phases;
extern int FftInitP;

/* Used for Schroedinger functional */
extern int SchrFun;
#if 0
EXTERN LatticeBoolean lSFmaskF;
EXTERN multi1d<LatticeBoolean> lSFmask(Nd);
EXTERN multi1d<LatticeColorMatrix> SFBndFld(Nd);
#endif

/* 3-d Totally antisymmetric tensor */
extern multi3d<int> antisym_tensor;

/* Phases used for Wilson hadron spectroscopy */
extern multi1d<int> meson_eta;
extern multi2d<int> meson_eta2;
extern multi1d<int> meson_sgn;
extern multi3d<int> baryon_chi;

/* Masks used in momentum shift measurement routines */
#define  MAX_MOMENTUM  9
// multi1d<LatticeBoolean> mom_mask(MAX_MOMENTUM);
extern int mom_mask_norm;

/* Phases used for SFT computation of non-zero momentum corrfn */
// multi1d<LatticeComplex> sft_phases(MAX_MOMENTUM);
extern int mom_norm;
extern int SftInitP;
...
#if defined(MAIN)
#if 0
multi3d<int> antisym_tensor(3,3,3);
multi1d<int> meson_eta(16);
multi2d<int> meson_eta2(16,16);
multi1d<int> meson_sgn(16);
multi3d<int> baryon_chi(4,4,6);
#endif
